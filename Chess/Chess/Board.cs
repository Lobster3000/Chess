...
namespace Chess
{
    class Board
    {
        ...
        public void resetBoard()
        {
            ...
            for (int i = 2; i<6; i++)
            {
                place[0, i].Figure = null; 
                place[1, i].Figure = null; 
                place[2, i].Figure = null; 
                place[3, i].Figure = null; 
                place[4, i].Figure = null; 
                place[5, i].Figure = null; 
                place[6, i].Figure = null; 
                place[7, i].Figure = null; 
            }
        }
    }
}
